...
export default function NaiveBayesPage() {
  ...
  return (
    <div className="bg-background flex w-full flex-col">
      <SiteHeader heading="Naive Bayes Classifier" />
      <main className="flex flex-col max-w-5xl w-full mx-auto">
        <div className="flex w-full flex-col gap-6 px-4 py-6 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold">Gaussian Naive Bayes</h2>
              <p className="text-muted-foreground">
                Train and evaluate Naive Bayes model for gas type classification
              </p>
            </div>
